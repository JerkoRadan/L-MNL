...
def denseNN(beta_num, choices_num, networkSize = 100, logits_activation = 'softmax'):
...
def denseNN_extra(beta_num, choices_num, nExtraFeatures, networkSize = 100, logits_activation = 'softmax'):
...
def enhancedMNL_sameInput(beta_num, choices_num, networkSize = 50, train_betas = True, minima = None, hidden_layers = 1, logits_activation = 'softmax'):
